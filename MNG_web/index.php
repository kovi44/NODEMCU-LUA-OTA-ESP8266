             ...
             echo "<table class='table table-striped'>
              ...
              ";
                ...
                foreach ($files as $value) {
                    ...
                    echo "<tr>";
                    echo "<th scope='row'>$value[id]</th><td>$value[filename]</td><td>$value[folder]</td><td>$value[boot]</td><td><a href='?files=$value[esp_id]&delfile=$value[id]' class='btn btn-danger' role='button'>Delete</a>&nbsp;<a href='?files=$value[esp_id]&boot=$value[id]' class='btn btn-success' role='button'>Boot Flag</a></td>";
                    echo "<tr>";
                  }
            echo "  </tbody>
              </table>";
